...
************************************************************************************************************************************
COMMENT ID:02
COMMENTOR NAME : Shyam Patil
METHODE/EVENT: Attachment/Detachment CR- 30234
REMARK: 
DateTime :21/04/2021
*********************************************************************************************************************************
*/
public partial class Appcode_Bpmuwmodule : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Request.Url.Segments[2].ToString() == "RevivalUwdecision.aspx")
            {
    ...
    protected void btnPost_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (IsCombi)
            {
                // Start Attachment / Detachment CR - 30234
                bool IsSuccess = false;
                bool IsPendingDecision1 = false;
                bool IsPendingDecision2 = false;
                string ApplicationNo1 = string.Empty;
                string ApplicationNo2 = string.Empty;
                //IsAttachmentDetachment(rptDecision, ref IsSuccess, ref IsPendingDecision1, ref IsPendingDecision2,ref ApplicationNo1, ref ApplicationNo2);
                // End Attachment / Detachment CR - 30234
                foreach (RepeaterItem item in rptDecision.Items)
                {
                    ...
                    strApplicationno = lblAppno.Text.Trim();
                    // Start Attachment / Detachment CR - 30234
                    if (IsPendingDecision1 && strApplicationno == ApplicationNo1)
                    {
                        continue;
                    }
                    else if (IsPendingDecision2 && strApplicationno == ApplicationNo2)
                    {
                        continue;
                    }
                    // End Attachment / Detachment CR - 30234
                    ...
                    RadioButton rb = (RadioButton)item.FindControl("rbYes");
                    RadioButton rb1 = (RadioButton)item.FindControl("rbNo");
                    objCommonObj._Restrict_Further_Cover = (rb == null) ? rb1.Text : rb.Text;
                    ...
                    ListBox ddlUWreason = (ListBox)item.FindControl("ddlUWreason1");
                    ...
                    UpdateDecisionInLa_Combi(ref response, ddlUWDecesion, ddlUWDecesioncategory, ddlUWreason, txtUWreason2, ddlPostpone, lblErrorDecisiondtls);
            ...
            else
            {
                ...
                if (Session["objCommonObj"] != null)
                {
                    ...
                    //Added By Royson Pinto on 22nd NOV to store Restrict Further Cover 
                    RadioButton rb = (RadioButton)ContentPlaceHolder1.FindControl("RadioButton1");
                    RadioButton rb1 = (RadioButton)ContentPlaceHolder1.FindControl("RadioButton2");
                    objCommonObj._Restrict_Further_Cover = (rb == null) ? rb1.Text : rb.Text;
                    if (objCommonObj._Restrict_Further_Cover != "")
                        Session["objCommonObj"] = objCommonObj;
                    //End
                ...
                //Bhaumik Patel Cr-3334
                ListBox ddlUWreason = (ListBox)ContentPlaceHolder1.FindControl("ddlUWreason1");
                TextBox txtUWreason2 = (TextBox)ContentPlaceHolder1.FindControl("txtUWreason2");
                //
    ...
    private void UpdateDecisionInLa_Combi(ref int response, DropDownList ddlUWDecesion, DropDownList ddlUWDecesioncategory, ListBox ddlUWreason,TextBox txtUWreason2, DropDownList ddlPostpone, Label lblErrorDecisiondtls)
    {
        ...
        Session["RequestType"] = "";
        if (Request.Url.Segments.Length == 3 && Request.Url.Segments[2].ToString() == "RevivalUwdecision.aspx")
        {
            Session["RequestType"] = "Revival";
        }
        ...
        //call servics
        //Bhaumik Patel Cr-3334
        string _strCategory = ddlUWDecesioncategory.SelectedValue == "0" ? "" : ddlPostpone.SelectedValue;
        string UWReason2value = "";
        string UWReason2 = "";
        string strddluereasonvalue = string.Empty;
        string strddluereasontext = string.Empty;
        string reasonscode = Request.Form[ddlUWreason.UniqueID];
        if (reasonscode !=null)
        {
            if (reasonscode.Split(',').Length > 1)
            {
                UWReason2value = reasonscode.Split(',')[1];
            }
            else
            {
                ddlUWreason.SelectedValue = reasonscode.Split(',')[0];
                strddluereasonvalue = ddlUWreason.SelectedItem.Value ;
                strddluereasontext = ddlUWreason.SelectedItem.Text;
                    if (!string.IsNullOrEmpty(Request.Form[txtUWreason2.UniqueID]))
                    {
        ...
        objComm.OnlineUWDecisionDetails_Save(objCommonObj._AppType, strApplicationno, ddlUWDecesion.SelectedItem.Text, strddluereasontext,
            ddlUWDecesion.SelectedValue, strddluereasonvalue, _strUWPeriod, struserid, objChangeObj.userLoginDetails._UserName,
      ...
      strApplicationno, UWReason2, UWReason2value, ref UWDecisionResult);

        int DecisionResult = 0;
        objComm.OnlineDecisionDetails_Save(strApplicationno, ddlUWDecesion.SelectedItem.Text, _strCategory, ddlUWDecesion.SelectedValue, UWReason2value, _strUWPeriod, objChangeObj.userLoginDetails._UserID, objChangeObj.userLoginDetails._UserName, objChangeObj.userLoginDetails._UserGroup, objChangeObj.userLoginDetails._userBranch, objChangeObj.userLoginDetails._ProcessName, ref DecisionResult);
        ...
        sb.Append(objCommonObj._AppType + "," + strApplicationno + "," + ddlUWDecesion.SelectedItem.Text + "," +
       strddluereasontext + "," + ddlUWDecesion.SelectedValue + "," + strddluereasonvalue + "," + _strUWPeriod
       + "," + struserid + "," + objChangeObj.userLoginDetails._UserName + "," + objChangeObj.userLoginDetails._UserGroup
       + "," + objCommonObj._bpm_branchCode + "," + objCommonObj._bpm_creationDate + "," + objCommonObj._bpm_systemDate + ","
       + objCommonObj._bpm_businessDate + "," + objChangeObj.userLoginDetails._userBranch + "," + objChangeObj.userLoginDetails._ProcessName
       + "," + strApplicationno + "," + UWDecisionResult);
    ...
    private void UpdateDecisionInLa(ref int response)
    {
        ...
        DropDownList ddlUWDecesion = (DropDownList)ContentPlaceHolder1.FindControl("ddlUWDecesion");
        //DropDownList ddlUWreason = (DropDownList)ContentPlaceHolder1.FindControl("ddlUWreason");
        DropDownList ddlUWDecesioncategory = (DropDownList)ContentPlaceHolder1.FindControl("ddlUWDecesioncategory");
        ListBox ddlUWreason = (ListBox)ContentPlaceHolder1.FindControl("ddlUWreason1");
        TextBox txtUWreason2 = (TextBox)ContentPlaceHolder1.FindControl("txtUWreason2");
        //DropDownList ddlPostpone = (DropDownList)ContentPlaceHolder1.FindControl("ddlPStart_Step18eriod");
        DropDownList ddlPostpone = (DropDownList)ContentPlaceHolder1.FindControl("ddlPeriod");
        ...
        string _strCategory = ddlUWDecesioncategory.SelectedValue == "0" ? "" : ddlPostpone.SelectedValue;
        string reasonscode = Request.Form[ddlUWreason.UniqueID];
        if (string.IsNullOrEmpty(reasonscode))
        {
            reasonscode = "";
        }
        string UWReason2value = "";
        ...
        string ddluwreason1 = string.Empty;
        string ddluwreason2 = string.Empty;
        if ((ddlUWreason.Items.Count==0) && (ddlUWreason.Items.Count==0))
        {
             ddluwreason1 = "";
             ddluwreason2 = "";
        }
        ...
        {
            ddluwreason1 = ddlUWreason.SelectedItem.Text.ToString();
            ddluwreason2 = ddlUWreason.SelectedItem.Value.ToString();
        }
       
        objComm.OnlineUWDecisionDetails_Save(objCommonObj._AppType, strApplicationno, ddlUWDecesion.SelectedItem.Text, ddluwreason1,
            ddlUWDecesion.SelectedValue, ddluwreason2, _strUWPeriod, struserid, objChangeObj.userLoginDetails._UserName,
        objChangeObj.userLoginDetails._UserGroup, objCommonObj._bpm_branchCode, objCommonObj._bpm_creationDate, objCommonObj._bpm_systemDate,
        objCommonObj._bpm_businessDate, objChangeObj.userLoginDetails._userBranch, objChangeObj.userLoginDetails._ProcessName,
      strApplicationno, UWReason2, UWReason2value, ref UWDecisionResult);
        ...
        sb.Append(objCommonObj._AppType + "," + strApplicationno + "," + ddlUWDecesion.SelectedItem.Text + "," +
        ddluwreason1 + "," + ddlUWDecesion.SelectedValue + "," + ddluwreason2 + "," + _strUWPeriod
        + "," + struserid + "," + objChangeObj.userLoginDetails._UserName + "," + objChangeObj.userLoginDetails._UserGroup
        + "," + objCommonObj._bpm_branchCode + "," + objCommonObj._bpm_creationDate + "," + objCommonObj._bpm_systemDate + ","
        + objCommonObj._bpm_businessDate + "," + objChangeObj.userLoginDetails._userBranch + "," + objChangeObj.userLoginDetails._ProcessName
        + "," + strApplicationno + "," + UWDecisionResult);
        ...
        try
        {
            ...
            try
            {
                ...
                if (dtclientinfo.Rows.Count > 0 && dtproductdetails.Rows.Count > 0 && dt.Rows.Count > 0)
                {
                    ...
                    {
                        Logger.Info(strApplicationno + "CounterOffer Failure" + " " + ex.Message.ToString() + System.Environment.NewLine);
                    }
    ...
    #region Attachment/Detachment CR- 30234
    private void IsAttachmentDetachment(Repeater rptDecision, ref bool IsSuccess, ref bool IsPendingDecision1, ref bool IsPendingDecision2, ref string ApplicationNo1, ref string ApplicationNo2)
    {
        //Al

        bool DetachLetter1 = false;
        bool DetachLetter2 = false;
        Detachment(rptDecision, ref IsSuccess, ref DetachLetter1, ref DetachLetter2, ref IsPendingDecision1, ref IsPendingDecision2, ref ApplicationNo1, ref ApplicationNo2);

        if (DetachLetter1)
        {
            //Letter 1//Followup
        }
        else if (DetachLetter2)
        {
            //Letter 2
        }
    }

    private void Detachment(Repeater rptDecision, ref bool IsSuccess, ref bool DetachLetter1, ref bool DetachLetter2, ref bool IsPendingDecision1, ref bool IsPendingDecision2, ref string ApplicationNo1, ref string ApplicationNo2)
    {
        try
        {
            string UWDecesion1 = string.Empty;
            string UWreason1 = string.Empty;
            string UWDecesion2 = string.Empty;
            string UWreason2 = string.Empty;
            int i = 0;
            bool IsDetach = false;
            foreach (RepeaterItem item in rptDecision.Items)
            {
                ...
                if (i == 1)
                {
                    UWDecesion1 = ddlUWDecesion.SelectedValue.Trim().ToLower();
                    UWreason1 = ddlUWreason.SelectedItem.Text.Trim().ToLower();
                    ApplicationNo1 = lblAppno.Text.Trim();
                }
                else if (i == 2)
                {
                    UWDecesion2 = ddlUWDecesion.SelectedValue.Trim().ToLower();
                    UWreason2 = ddlUWreason.SelectedItem.Text.Trim().ToLower();
                    ApplicationNo2 = lblAppno.Text.Trim();
                }
            }

            if (UWDecesion1 == "approved" && UWreason1 == "standard")
            {
                switch (UWDecesion2)
                {
                    case "declined":
                    ...
                    case "withdrawn":
                        IsDetach = true;
                        DetachLetter1 = true;
                        IsPendingDecision1 = true;
                        break;
                    case "proposal":
                        //if (UWreason2 == "Rated Up")//Rated Up
                        //{
                        IsDetach = true;
                        DetachLetter2 = true;
                        // }
            ...
            else if (UWDecesion1 == "proposal")//Rated Up //else if (UWDecesion1 == "Approved" && UWreason1 == "Rated Up")//Rated Up
            {
                switch (UWDecesion2)
                {
                    case "declined":
            ...
            else if ((UWDecesion1 == "declined" || UWDecesion1 == "postponed" || UWDecesion1 == "withdrawn") && UWDecesion2 == "approved")
            {
                IsDetach = true;
                if (UWreason2 == "standard")
                {
                    DetachLetter1 = true;
                    IsPendingDecision2 = true;
                }
            }
            else if (UWDecesion1 == "approved" && UWDecesion2 == "Approved" && UWreason1 == "proposal")//Rated Up
            {
                IsDetach = true;
            }
            ...
            if (IsDetach)
            {
                ...
                string[] ApplicationNumbers = lblCaptionAppNo.Text.Trim().Split(':');
                strParentappNo = ApplicationNumbers[1].ToString().Trim();

                string strAppType = string.Empty;
                DataSet dtCombidetach = new DataSet();
                objUWDecision.OnlineApplicationLAServiceDetails_PUSH(strParentappNo, strAppType, objChangeObj, ref dtCombidetach, ref _dsPrevPol, "COMBIDET", ref strLApushErrorCode, ref strLApushStatus, ref strConsentRespons);
                if (strLApushErrorCode == 0)
                {
                    objComm.UpdateCombiFlag_Detach(ref _ds, strParentappNo, strChannelType);
                    IsSuccess = true;
    ...
    #endregion
    //3.1 Begin of Changes; Bhaumik Patel - [CR-5307]
    protected void lnklogout_Click(object sender, EventArgs e)
    {
        int result = 0;
        string strUserId = string.Empty;
        string struserName = string.Empty;
        string strUserGroup1 = string.Empty;
        objCommonObj = (CommonObject)Session["objCommonObj"];
        strUserId = objCommonObj._Bpmuserdetails._UserID;
        strUserGroup1 = objCommonObj._Bpmuserdetails._UserGroup;
        struserName = objCommonObj._Bpmuserdetails._UserName;
        
        CommAssD.Underwriting_AssignmentDetails_LOGINLOGOUT_Log(strUserId, struserName, strUserGroup1, "LogOut", "Insert_Logout_Logs", "0", ref result);
        CommAssD.Underwriting_LOGIN_Log("INSERT_LOGOUT_LOGS", Session["NewSessionId"].ToString(), "", strUserId, "", "", "", "LogOut From UWDecision", "SaralUW", 1, 1, ref result);
        if (result > 0)
        {
            Session.Abandon();
            Session.RemoveAll();
    ...
    //3.1 End of Changes; Bhaumik Patel - [CR-5307]
}