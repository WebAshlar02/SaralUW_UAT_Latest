...
// Description          : Email and SMS to be triggered for Consent Letter
//******************************************************************************************************//--%>
<%--//*************************************************************************************************
//*                      FUTURE GENERALI INDIA                        *    
//*****************************************************************************************************/      
...
// Description          :.Add ENYRiskScore and RiskScore
//**********************************************************************
//**********************************************************************
// Sr. No.              : 38
// Company              : Life            
...
// BRD/CR/Codesk No/Win : CR-4783-1 
// Date Of Creation     : 22/11/2022
// Description          :.Creating Restrict Further Cover
//**********************************************************************
...
<%@ Page Title="" Language="C#" MasterPageFile="~/Appcode/Bpmuwmodule.master" AutoEventWireup="true"  ClientIDMode="Static" CodeFile="Uwdecision.aspx.cs" Inherits="Appcode_Default" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        //36.1 Start of Changes; Sushant Devkate - [MFL00905]
   ...
   <%-- <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            prm.add_endRequest(function () {
                ...
                $('#chkReqDtls').change(function () {
                  ...
                  <%--// 42.1 Begin of Changes; Jayendra  - [Webashlar01]--%>
                ...
                <%--// 42.1 End of Changes; Jayendra  - [Webashlar01]--%>
                //Journal Details
                ...
                $('#chkAppDtls').change(function () {
                    if ($('#chkAppDtls').is(':checked')) {
                        ...
                        $('#ddlRsnExcessPremium').removeClass('lblLable');
                        //end
                        ...
                        //Added by pragati CR 27524
                        $('#ddlRsnExcessPremium').addClass('lblLable');
                        //end
                    }
                });
        ...
        /*35.1 End of Changes; Bhaumik Patel - [CR-4134]*/
         ...
         <%--41.1 Begin of Changes; Bhaumik Patel - [CR-4753]--%>
        ...
        function CheckvalidationEXApp() {
         ...
         <%--41.1 End of Changes; Bhaumik Patel - [CR-4753]--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div id="Appdtls_container" class="box box-warning box-solid ">
                    ...
                    <div id="Appdtls_containerBody" class="box-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <%--end here--%>
                             <%--added by Suraj on 22-JUL-2020 to add checkbox for POS product suggected by Prafulla --%>
                            <div id="div36" runat="server" class="col-md-2">
                                <div class="form-group">
                                    <label>POS Flag</label>
                                    <div class="form-group">
                                       <asp:CheckBox ID="chkPOS" CssClass="form-control lblLable" AutoPostBack="true" runat="server" Text="POS Flag"></asp:CheckBox><%--onchange="fnChaneNsap();" --%>
                                    </div>
                                </div>
                            </div>
                            <%--end here--%>
                             <%-- Pragati changes start Cr 27524--%>
                            <div id="div38" runat="server" class="col-md-2" style="width: auto;">
                                <div class="form-group">
                                    <label>Excess Premium Reason</label>
                                    <div class="form-group">
                                        <asp:DropDownList ID="ddlRsnExcessPremium" CssClass="form-control lblLable" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                             <%-- Pragati changes End Cr 27524--%>
                        </div>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="GridMsarTsar" CssClass="table table-bordered table-striped" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <%--43.1 Begin of Changes; Bhaumik Patel - [CR-5523]--%>
                                    <asp:BoundField HeaderText="Death Benefit" DataField="DEATHBENEFIT" />
                                    <%--43.1 End of Changes; Bhaumik Patel - [CR-5523]--%>
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
   ...
   <div id="div34" class="col-md-12" runat="server">
    ...
    <div id="divProductDetails" runat="server" class="col-md-12 HideControl">
        <asp:UpdatePanel ID="updProductDetails" UpdateMode="Conditional" runat="server">
            ...
            <Triggers>
                ...
                <%--<asp:PostBackTrigger ControlID="btncalculatePrem_Prod" />--%>
            </Triggers>
        </asp:UpdatePanel>
    </div>
    ...
    <div id="div6" runat="server" class="col-md-12 HideControl">
        <asp:UpdatePanel ID="uptest" UpdateMode="Conditional" runat="server">
            ...
            <Triggers>
                ...
                <%--<asp:PostBackTrigger ControlID="gvRiderDtls" />--%>
            </Triggers>
        </asp:UpdatePanel>
    </div>
    <%--end here--%>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Description" HeaderStyle-CssClass="ReqDescp">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:TextBox ID="lblfollowupDiscp" CssClass="form-control"
                    ...
                    <div class="box-body">
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtRateAdjust" TextMode="Number" runat="server"  CssClass="form-control lblLable Numeric" ></asp:TextBox>
                                            <%--//44.1 Begin of Changes; Bhaumik Patel - [CR-5855]--%>
                                            <asp:RangeValidator ID="rgvrateAdjust" runat="server" ControlToValidate="txtRateAdjust" SetFocusOnError="True"  ></asp:RangeValidator>
                                             <%--//44.1 END of Changes; Bhaumik Patel - [CR-5855]--%>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label></label>
                                    <asp:Button runat="server" ID="btncalculatePrem_Load" OnClick="btncalculatePrem_Load_Click" Text="Calculate Premium"  CssClass="btn btn-primary HideControl lnkButton" />
                                </div>
                            </div>
                            <asp:UpdatePanel ID="updAddloading" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <asp:Button ID="btnAddLoadingRow" CssClass="btn btn-primary HideControl lnkButton" CausesValidation="True" UseSubmitBehavior="True"  OnClientClick="return ValidateLoadingtDtls()" runat="server" Text="Add New Row" OnClick="btnAddLoadingRow_Click" Enabled="true" />
                                            </div>
                                        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="form-group">
                                <label>Is Smoker</label><br />
                                <div class="form-group">
                                     <!-- added OnChange="fnChangeSmokar(this)" 36.1 Start of Changes; Sushant Devkate - [MFL00905]-->
                   ...
                   <div class="col-md-2">
                         ...
                         <div class="col-md-2 form-group">
                              <label>Aml Risk Score</label>
                                <br/>
                            <asp:DropDownList ID="DrpAml" disabled="true" readonly="true" AutoPostBack="true" CssClass="form-control" runat="server" onchange="fnLoaderShow();" OnSelectedIndexChanged="DrpAml_SelectedIndexChanged"  >
                        ...
                        <%--ADDED ON 09 JULY 21 BY Suraj TO SHOW Business Exception--%>
                         <div class="col-md-2 form-group">
                           <div class="form-group">
                        ...
                        <%--//40.1 Begin of Changes; Bhaumik Patel - [CR-5307]--%>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <%--//40.1 End of Changes; Bhaumik Patel - [CR-5307]--%>
                    </div>
                </div>
            </ContentTemplate>
            <Triggers>
    ...
    <div id="divCommentDetails" runat="server" class="col-md-12">
       <!-- added UpdateMode="Conditional" --  36.1 Start of Changes; Sushant Devkate - [MFL00905]-->
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12">
                           ...
                           <div id="divUWCategory" runat="server" visible="false">
                            ...
                            <div id="divUWReason1" runat="server" visible="false">
                               ...
                               <%--45.1 Begin of Changes; Sagar Thorave - [CR-7049]--%>
                            <div id="Acceptance_Reason" runat="server" visible="false">
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <asp:listbox ID="ddlAcceptanceReason" CssClass="form-control label" Style="width: 100%;"  runat="server"  SelectionMode="Multiple" >
                                            </asp:listbox>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <%--<div class="col-md-4">
                                 <div class="col-md-12">
                                      <div class="form-group">
                                           <asp:RequiredFieldValidator ID="RFVddlUWreason1" runat="server" ErrorMessage="Please Select UW Reason1 ...." ControlToValidate="ddlUWreason1" EnableViewState="False" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                      </div>
                                  </div>
                            </div>--%>
                            <div class="col-md-12">
