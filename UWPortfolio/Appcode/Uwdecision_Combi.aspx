...
// Company              : Life            
// Module               : UW Saral         
// Program Author       : Bhaumik Patel - MFL00886
...
<%@ Page Title="" Language="C#" MasterPageFile="~/Appcode/Bpmuwmodule.master" AutoEventWireup="true"
    ClientIDMode="Static" CodeFile="Uwdecision_Combi.aspx.cs" Inherits="Appcode_Default" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style type="text/css">
        ...
        */
        ...
        /*35.1 Begin of Changes; Bhaumik Patel - [CR-4134]*/
        .blank {
            display: none;
        }
        /*35.1 End of Changes; Bhaumik Patel - [CR-4134]*/
        ...
        /*Added By Royson Pinto on 22nd NOV to style Radio Buttons*/
        input[type="radio"] {
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (confirm("Do you want to detach the policy? It will no longer as combi product.")) {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            prm.add_endRequest(function () {
                ...
                $('#chkReqDtls').change(function () {
                    ...
                    <%--// 41.1 Begin of Changes; Jayendra  - [Webashlar01]--%>
                ...
                <%--// 41.1 End of Changes; Jayendra  - [Webashlar01]--%>
                //Journal Details
                ...
                $('#chkLoadingDtls').change(function () {
                    ...
                    if ($('#chkLoadingDtls').is(':checked')) {
                        ...
                        $('#ddlAppNo').removeClass('lblLable');//added by suraj for combi
                    }
                    else {
                        ...
                        $('#ddlAppNo').addClass('lblLable');//added by suraj for combi
                    }
                });
              ...
              <%--44.1 Begin of Changes; Sagar Thorave - [CR-7049]--%>
                $(document).ready(function () {
                    $('.ddlAcceptanceReason').SumoSelect();
                    //45.1 Begin of Changes; Jayendra - [Webashlar01]
                    var ddlAcceptanceReasonElements = $(".ddlAcceptanceReason");
                    $.each(ddlAcceptanceReasonElements, function (i) {
                        var ddlEle = ddlAcceptanceReasonElements[i];
                        if ($(ddlEle).val() && $(ddlEle).val().includes("Others (Free Text)")) {
                            let _index = i + 1;
                            $(".txtAcceptanceOtherReasonText_" + _index).parents('.divAcceptanceOtherReasonText').show();
                        }
                    });
                    $('.ddlAcceptanceReason').change(function (event) {
                        debugger
                        var ddlEle = $(this);
                        var classStr = ddlEle.attr("class")
                        var startIndex = classStr.indexOf("_");
                        var length = classStr.indexOf(" ", startIndex + 1) - 1 - startIndex;
                        var index = classStr.substr(startIndex + 1, length);

                        if (ddlEle.val() && ddlEle.val().includes("Others (Free Text)")) {
                            $(".txtAcceptanceOtherReasonText_" + index).parents('.divAcceptanceOtherReasonText').show();
                        } else {
                            $(".txtAcceptanceOtherReasonText_" + index).val("");
                            $(".txtAcceptanceOtherReasonText_" + index).parents('.divAcceptanceOtherReasonText').hide();
                        }
                    });
              ...
              <%--44.1 End of Changes; Sagar Thorave - [CR-7049]--%>
                var arr = [];
                var arr1 = [];
                ...
                $('.ddlUWreason1').change(function (event) {
                    debugger
                    if (event.currentTarget.classList.toString().indexOf("ddlUWreason1_1") >= 0) {
                        arr1 = [];
                        var listBox1 = document.getElementsByClassName("ddlUWreason1_1")[0];
                        for (var i = 0; i < listBox1.options.length; i++) {
                            if ($('.ddlUWDecesion_1').val() === 'Approved' || $('.ddlUWDecesion_1').val() === 'Withdrawn') {
                                if (listBox1.options[i].selected) {
                                    arr1.push(listBox1.options[i].text);
                                    if (arr1.length > 1) {
                                        arr1 = [];
                                        listBox1.sumo.unSelectAll();
                                        alert("Please Select Minimum  and Maximum  ONE Reasons.....");
                                        return false;
                                    }
                        ...
                        for (var j = 0; j < arr1.length; j++) {
                            ...
                            if (j === 1) {
                                $('.txtUWreason2_1').val(arr1[j]);
                            }
                        }

                    } else {
                        arr1 = [];
                        //var listBox1 = document.getElementById(event.currentTarget.id);
                        var listBox1 = document.getElementsByClassName("ddlUWreason1_2")[0];
                        for (var i = 0; i < listBox1.options.length; i++) {
                            if ($('.ddlUWDecesion_2').val() === 'Approved' || $('.ddlUWDecesion_2').val() === 'Withdrawn') {
                                if (listBox1.options[i].selected) {
                                    arr1.push(listBox1.options[i].text);
                                    if (arr1.length > 1) {
                                        arr1 = [];
            ...
            $('#ddlUWreason1').change(function (event) {
                ...
                for (var i = 0; i < listBox1.options.length; i++) {
                    ...
                    if ($('#ddlUWDecesion').val() === 'Approved' || $('#ddlUWDecesion').val() === 'Withdrawn') {
                        if (listBox1.options[i].selected) {
                            arr1.push(listBox1.options[i].value);
                            if (arr1.length > 1) {
                                arr1.pop();
                                listBox1.sumo.unSelectItem(listBox1.options[i].index);
                                alert("Please Select Minimum  and Maximum  ONE Reasons.....");
        ...
        <%--40.1 Begin of Changes; Bhaumik Patel - [CR-4753]--%>
        function fnEnableDisableNewExAprrove(req) {
            debugger
            if ($(req).find('input[type="checkbox"]').is(':checked')) {

                $(req).parents().find('.box-body').find('.ddlEXAprrovaluwdecision').removeClass('lblLable');
                $(req).parents().find('.box-body').find('.btnEXAPSave').removeClass('HideControl');
            }
            else {


                $(req).parents().find('.box-body').find('.ddlEXAprrovaluwdecision').addClass('lblLable');
                $(req).parents().find('.box-body').find('.btnEXAPSave').addClass('HideControl');
            }
        }

        function ValidateEXAppDetailsBlog() {
            debugger
            var flag = true;
            $("#gridExaprroval tr:has(td)").each(function () {
                var ddlEXAprrovaluwdecision = $(this).find('#ddlEXAprrovaluwdecision').val();
                if (ddlEXAprrovaluwdecision == "") {
                    $(this).find('#ddlEXAprrovaluwdecision').addClass('EmptyVal');
                    flag = false;
                }
                else {
                    $(this).removeClass('EmptyVal');
            ...
            if (flag == false) {
                $('#lblErrorinfo').html("In Exception approval field in red marked are mandatory field");
                $('#myModal').modal();
            }
            return flag;
        }
        function CheckvalidationEXApp() {
            if (!ValidateEXAppDetailsBlog()) {
                Flag = false;
                return Flag;
            }
        }
        <%--40.1 End of Changes; Bhaumik Patel - [CR-4753]--%>
        ...
        //34.1 Begin of changes CR-30543 by sushant Devkate [MFL00905]
...
//34.1 End of changes CR-30543 by sushant Devkate [MFL00905]
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="retPoup">
        <div class="modal fade modal-info" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document" style="width: auto!important; padding-left: 20%!important">
                ...
                <div id="PreIssue_container" class="box box-warning box-solid ">
                    ...
                    <div class="box-body">
                        ...
                        <div id="divpreissueval" visible="false" runat="server" class="col-md-12">
                            <asp:Repeater runat="server" ID="rptpreissue">
                                <HeaderTemplate>
                                    <div class="">
                                </HeaderTemplate>
                                <ItemTemplate>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <div style="text-align: center">
                                                <label>Applocationno</label>
                                            </div>
                                            <div style="text-align: center">
                                                <asp:TextBox ID="txtAppnoPreissue" CssClass="form-control lblLable Numeric alphanumeric" Text='<%#Eval("Applicationno") %>' runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div style="text-align: center">
                                                <asp:TextBox ID="txtTotalPremDue" CssClass="form-control lblLable Numeric alphanumeric" Text='<%#Eval("TOATALAMOUNT") %>' runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div style="text-align: center">
                                                <asp:TextBox ID="txtAmountinsuspense" CssClass="form-control lblLable Numeric alphanumeric" Text='<%#Eval("AMOUNTINSUSPENCE") %>' runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div style="text-align: center">
                                                <asp:TextBox ID="txtPremServiceTax" CssClass="form-control lblLable Numeric alphanumeric" Text='<%#Eval("SERVICETAX") %>' runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div style="text-align: center">
                                                <asp:TextBox ID="txtPrebackdateintrest" CssClass="form-control lblLable Numeric alphanumeric" Text='<%#Eval("BACKDATINGINTEREST") %>' runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div style="text-align: center">
                                                <asp:TextBox ID="txtAmountdue" CssClass="form-control lblLable Numeric alphanumeric" Text='<%#Eval("AMOUNTDUE") %>' runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </ItemTemplate>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-2 ">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtAgentvintage" CssClass="form-control lblLable" Text="" runat="server" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                            <%--END HERE--%>
                        </div>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="GridMsarTsar" CssClass="table table-bordered table-striped" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <%--42.1 Begin of Changes; Bhaumik Patel - [CR-5523]--%>
                                    <asp:BoundField HeaderText="Death Benefit" DataField="DEATHBENEFIT" />
                                    <%--42.1 End of Changes; Bhaumik Patel - [CR-5523]--%>
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="GridRedFlag" CssClass="table table-bordered table-striped" AutoGenerateColumns="false" AllowPaging="true" PageSize="5" OnPageIndexChanging="GridRedFlag_PageIndexChanging">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Flag By" DataField="Flag_By" />
        ...
        <asp:UpdatePanel ID="UpdatePanel20" runat="server">
            <ContentTemplate>
                <div id="xyz" class="box box-warning box-solid">
                    ...
                    <%--  Start 33.1: This CR-2809 changes done by Sushant Devkate MFL00905 --%>
                    ...
                    <%--  End 33.1: This CR-2809 changes done by Sushant Devkate MFL00905 --%>
                </div>
            </ContentTemplate>
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="lnkSarDtlsRefresh" />
                        ...
                        <div id="divProdDetailsBase" runat="server">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtAppno" CssClass="form-control" Text='<%#Eval("AppNo") %>' runat="server" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Policy Number</label>
                                                    <asp:TextBox ID="txtBasepolno" CssClass="form-control" Text='<%#Eval("PolicyNo") %>' runat="server" ReadOnly="true"></asp:TextBox>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtProdcode" CssClass="form-control" Text='<%#Eval("ProductCode") %>' runat="server" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Product Name</label>
                                                    <asp:TextBox ID="txtProname" CssClass="form-control" Text='<%#Eval("ProdcutName") %>' runat="server" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtPolterm" CssClass="form-control Numeric" Text='<%#Eval("PolicyTerm") %>' runat="server" Enabled="false" MaxLength="2"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Premium Paying Term</label>
                                                    <asp:TextBox ID="txtPrepayterm" CssClass="form-control Numeric" Text='<%#Eval("PremiumTerm") %>' runat="server" Enabled="false" MaxLength="2"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Sum Assured</label>
                                                    <asp:TextBox ID="txtSumassure" CssClass="form-control Numeric" Text='<%#Eval("SumAssured") %>' runat="server" Enabled="false"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtBasepremium" CssClass="form-control  Numeric" Text='<%#Eval("BasePremium") %>' runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Service Tax</label>
                                                    <asp:TextBox ID="txtServicetax" CssClass="form-control Numeric" Text='<%#Eval("ServiceTax") %>' runat="server" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Total Premium</label>
                                                    <asp:TextBox ID="txtTotalpremium" CssClass="form-control  Numeric" Text='<%#Eval("TotalPremium") %>' runat="server" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Branch Base Premium</label>
                                                    <asp:TextBox ID="txtProdBranchBasePremium" CssClass="form-control" Text='<%#Eval("BranchBasePremium") %>' runat="server" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div runat="server" visible="true" class="col-md-3">
                                                <div class="form-group">
                                                    <label id="lblMonthlyPayout" runat="server">Monthly Payout</label>
                                                    <asp:TextBox ID="txtMonthlyPayoutBase" CssClass="form-control Numeric" Text='<%#Eval("MonthlyPayout") %>' runat="server" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div id="divpayoutfreq" runat="server" visible="false" class="col-md-3">
                                                <div class="form-group">
                                                    <label id="lblpayoutfreq" runat="server">Survival Benefit PayOutFrquency</label>
                                            ...
                                            <div id="divprodcategory" runat="server" visible="false" class="col-md-3">
                                                <div class="form-group">
                                                    <label id="Label15" runat="server">Product Category</label>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label></label>
                                        <asp:Button runat="server" ID="btncalculatePrem_Prod" OnClientClick="return ValidateProductDetailsBlog();" OnClick="btncalculatePrem_Prod_Click" Text="Calculate Premium" CssClass="form-control btn-primary lnkButton" />
                                    </div>
                                </div>
    ...
    <%--added by suraj for combi details which is detach from product --%>
    <%-- <div id="div36" runat="server" class="col-md-12">
        <asp:UpdatePanel ID="UpdatePanel18" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <div id="divCombiDetails_container" class="box box-warning box-solid">
                    <div class="box-header with-border">
                        <div class="col-md-12">
                            <div class="col-md-9">
                                <h3 class="box-title ">Combi Basic Product Details</h3>
                                <i class="fa fa-inr"></i>
                            </div>
                            <div class="col-md-3">

                                <div class="col-md-4" style="float: right">
                                    <input type="checkbox" id="cbEditCombiDetail" class="CheckSave CheckSave1" onchange="fnEnableDisable(this);" />
                                    <label for="cbEditCombiDetail">Edit</label>
                                </div>
                                <div class="col-md-3" style="float: unset">
                                    <asp:Button ID="btndetach" class="btn-primary btnSave1" runat="server" Text="Detach" OnClientClick="return Confirm();" OnClick="btndetach_Click" />
                                </div>
                            </div>
                        </div>
                        <div class="box-tools ">
                    ...
                    <div class="box-body">
                        <div class="col-md-12 error-container-div">
                            <div class="col-md-6" onclick="fnHideShowErrorMsg(this);">
                                <div class="col-md-6 HideControl error-detail_div">
                                    <div class="form-group">
                                        <asp:Label ID="lblcombidetailerror" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                    </div>
                                </div>
    ...
    <%--  <div class="col-md-12">
                            <div class="table-responsive">
                                <asp:GridView ID="gvCombiDetails_detach" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Select">
                                            ...
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkremovepolicy" class="cbEnableDisable OnlyOneRider lblLable" runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="ApplicationNo">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtCombiAppno" Text='<%#Eval("Appno") %>' CssClass="form-control lblLable" TabIndex="-1" runat="server" onkeydown="return false;" AutoPostBack="false" onkeypress="return false;"></asp:TextBox>

                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="PolicyNo">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtCombiPolicyno" Text='<%#Eval("PolNum") %>' CssClass="form-control lblLable" TabIndex="-1" runat="server" onkeydown="return false;" AutoPostBack="false" onkeypress="return false;"></asp:TextBox>
                                                <asp:HiddenField ID="hdnCombiPolNo" runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="ProductName">
                                            <ItemTemplate>
                                                <asp:Label ID="lblProductName" CssClass="form-control lblLable" runat="server" Text='<%#Eval("ProdName") %>' onkeydown="return false;" onkeypress="return false;"></asp:Label>

                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="ProductCode">
                                            <ItemTemplate>
                                                <asp:Label ID="lblProductCode" CssClass="form-control lblLable" runat="server" Text='<%#Eval("ProdCode") %>' onkeydown="return false;" onkeypress="return false;"></asp:Label>

                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="SumAssure">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtSumAssure" Text='<%#Eval("SA") %>' CssClass="form-control lblLable Numeric" runat="server"></asp:TextBox>

                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="TotalPremium">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtCombiTotalPremium" Text='<%#Eval("TotalPrem")%>' CssClass="form-control lblLable" TabIndex="-1" runat="server" onkeydown="return false;" AutoPostBack="false" onkeypress="return false;"></asp:TextBox>
    ...
    <%-- </div>
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="btndetach" />
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvRiderDtls" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="ApplicationNo">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAppno" CssClass="form-control lblLable" runat="server" Text='<%#Eval("Appno") %>' onkeydown="return false;" onkeypress="return false;"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="PolicyNumber">
                                            <ItemTemplate>
                                                <asp:Label ID="lblpolNum" CssClass="form-control lblLable" runat="server" Text='<%#Eval("POLNUM") %>' onkeydown="return false;" onkeypress="return false;"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:GridView ID="gvRequirmentDetails" CssClass="table table-bordered table-striped lblLable RequirementBox " runat="server" AutoGenerateColumns="False" OnRowDataBound="gvRequirmentDetails_RowDataBound">
                                            <Columns>
                                                <asp:TemplateField HeaderText="App No">
                                                    <HeaderTemplate>
                                                        <asp:Label ID="Label1" runat="server" Text="AppNo"></asp:Label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:DropDownList CssClass="form-control" ID="ddlAppNoReq" runat="server" Width="140px" ClientIDMode="Static">
                                                            <asp:ListItem Value="0">--select--</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Code">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:DropDownList CssClass="form-control" ID="ddlfollowupcode" Width="80px" runat="server" OnSelectedIndexChanged="ddlfollowupcode_SelectedIndexChanged" AutoPostBack="true" ClientIDMode="Static">
                                                            <asp:ListItem Value="0">--select--</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Description" HeaderStyle-CssClass="ReqDescp">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:TextBox ID="lblfollowupDiscp" CssClass="form-control" Width="300px"
                                                ...
                                                <asp:TemplateField HeaderText="Category">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:DropDownList CssClass="form-control" ID="ddlCategory" Width="100px" runat="server" ClientIDMode="Static">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                            ...
                            <ContentTemplate>
                                ...
                                <div class="col-md-2 pull-right">
                                    <div class="form-group">
                                        ...
                                        <asp:LinkButton ID="btnMedDataentry" CssClass="HideControl" Text="Medical Data Entry" runat="server" OnClick="btnMedDataentry_Click1"></asp:LinkButton>
                                    </div>
                                </div>
                                <div class="col-md-2 pull-right">
                                    <div class="form-group">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <asp:GridView ID="gvRequirmentDetails_STP" CssClass="table table-bordered table-striped lblLable RequirementBox " runat="server" AutoGenerateColumns="False" OnRowDataBound="gvRequirmentDetails_STP_RowDataBound">
                                            <Columns>
                                                <asp:TemplateField HeaderText="App No">
                                                    <HeaderTemplate>
                                                        <asp:Label ID="Label1_STP1" runat="server" Text="AppNo"></asp:Label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:DropDownList CssClass="form-control" ID="ddlAppNoReq_STP" runat="server" Width="140px" ClientIDMode="Static">
                                                            <asp:ListItem Value="0">--select--</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
    ...
    <div id="divLoadingDetails" runat="server" class="col-md-12">
        <asp:UpdatePanel ID="updLoadingDetails" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
            <ContentTemplate>
                <div id="LoadingDtls_container" class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12">
                            <asp:UpdatePanel runat="server" ID="UpdAppno" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                <ContentTemplate>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Application No</label>
                                            <asp:DropDownList ID="ddlAppNo" CssClass="form-control lblLable" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlAppNo_SelectedIndexChanged" Enabled="true">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlLoadRiderCode" CssClass="form-control " runat="server" Enabled="true">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </ContentTemplate>
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="ddlAppNo" EventName="SelectedIndexChanged" />
                                    <%--<asp:AsyncPostBackTrigger ControlID="ddlLoadRiderCode" />--%>
                                </Triggers>
                            </asp:UpdatePanel>
                            <%--38.1 Begin of Changes; Bhaumik Patel - [CR-3334]--%>
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel3" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Reason </label>
                                            <asp:ListBox ID="ddlLoadRsn1" runat="server" CssClass="form-control lblLable" SelectionMode="Multiple"></asp:ListBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <%--//43.1 Begin of Changes; Bhaumik Patel - [CR-5855]--%>
                                ...
                                <asp:UpdatePanel ID="updAddloading" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label></label>
                                                <asp:Button runat="server" ID="btncalculatePrem_Load" OnClick="btncalculatePrem_Prod_Click" Text="Calculate Premium" CssClass="btn btn-primary HideControl lnkButton" />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label></label>
                                                <asp:Button ID="btnAddLoadingRow" CssClass="btn btn-primary HideControl lnkButton" CausesValidation="True" UseSubmitBehavior="True" OnClientClick="return ValidateLoadingtDtls()" runat="server" Text="Add New Row" OnClick="btnAddLoadingRow_Click" />
                                            </div>
                                        </div>
                                        </div>
                                    <div class="col-md-12">
                                            ...
                                            <asp:GridView ID="gvLoadingDtls" CssClass="table table-bordered table-striped" runat="server" AutoGenerateColumns="False">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Application No">
                                                        <HeaderTemplate>
                                                            <asp:Label ID="Label2" runat="server" Text="Application No"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblAppno" runat="server" Text='<%# Bind("ddlAppno") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <%--end--%>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvExtLoadDetails" AutoGenerateColumns="False" CssClass="table table-bordered table-striped" runat="server" OnRowDataBound="gvExtLoadDetails_RowDataBound">
                                            <Columns>
                                                <asp:TemplateField HeaderText="Application No.">
                                                    <HeaderTemplate>
                                                        <asp:Label ID="Label3" runat="server" Text="Application No."></asp:Label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblAPPno" CssClass="form-control lblLable" runat="server" Text=""></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="LoadingType">
                                                    <HeaderTemplate>
            ...
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="gvExtLoadDetails" />
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="form-group">
                                <label>Is Smoker</label><br />
                                <div class="form-group">
                                    <!-- added OnChange="fnChangeSmokar(this)" 34.1 Start of Changes; Sushant Devkate - [MFL00905]-->
                                    <asp:CheckBox runat="server" ID="chkSaralRiskIsSmoker" OnChange="fnChangeSmokar(this)" AutoPostBack="true" OnCheckedChanged="chkRiskParamIsSmoker_CheckedChanged" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <br />
                                <asp:Button ID="Update_ENY" runat="server" Text="Update ENY" CssClass="btn-primary " OnClick="Update_ENY_Click" />
                            </div>
                        </div>
                        <!--36.1 Start of Changes; Sagar Thorave - [MFL00886]-->
                        <div class="col-md-2 form-group">
                            <label>Aml Risk Score</label>
                            <br />
                            <asp:DropDownList ID="DrpAml" AutoPostBack="true" disabled="true" CssClass="form-control" runat="server" onchange="fnLoaderShow();" OnSelectedIndexChanged="DrpAml_SelectedIndexChanged">
                                <asp:ListItem Value="1">Low Risk</asp:ListItem>
                                <asp:ListItem Value="2">Medium Risk</asp:ListItem>
                                <asp:ListItem Value="3">Very High Risk</asp:ListItem>
                                <asp:ListItem Value="4">High Risk</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <!--36.1 End of Changes; Sagar Thorave - [MFL00886]-->
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <%--//39.1 Begin of Changes; Bhaumik Patel - [CR-5307]--%>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Risk Category</label><br />
                                <asp:TextBox ID="txtriskcat" CssClass="form-control " Text="" ReadOnly="true" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <%--//39.1 End of Changes; Bhaumik Patel - [CR-5307]--%>
                    </div>
                </div>
            </ContentTemplate>
            <Triggers>
    ...
    <%--END HERE--%>
    <%--40.1 Begin of Changes; Bhaumik Patel - [CR-4753]--%>
    <div id="divExceptionapproval" runat="server" class="col-md-12 ">
        <asp:UpdatePanel ID="UpException_approval" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <div id="Exception_approvalDtls_container" class="box box-warning box-solid">
                    <div class="box-header with-border">
                        <div class="col-md-12">
                            <div class="col-md-9">
                                <h3 class="box-title ">Exception approval Details</h3>
                            </div>
                            <div class="col-md-3">
                                <div class="col-md-4" style="float: right">
                                    <asp:CheckBox ID="CheckEXAp" runat="server" Text="Edit" Onchange="fnEnableDisableNewExAprrove(this);" />
                                </div>
                                <div class="col-md-3" style="float: right">
                                    <asp:Button ID="btnEXAPSave" OnClientClick="return CheckvalidationEXApp();" CssClass="btn-primary btnEXAPSave HideControl " runat="server" Text="Save" OnClick="btnEXAPSave_Click" />
                                </div>
                            </div>
                        </div>
                        <div class="box-tools ">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gridExaprroval" CssClass="table table-bordered table-striped" AutoGenerateColumns="false">
                                <Columns>
                                    <%-- <asp:BoundField HeaderText="Application No" DataField="ApplicationNo" />--%>
                                    <%--<asp:BoundField HeaderText="BOEID" DataField="BOEID"  HeaderStyle-CssClass="blank" ItemStyle-CssClass="blank"  >
                                    <HeaderStyle CssClass="blank" />
                                    <ItemStyle CssClass="blank" />
                                    </asp:BoundField>--%>
                                    ...
                                    <asp:TemplateField HeaderText="Parameter">
                                        <ItemTemplate>
                                            <asp:TextBox CssClass="form-control txtEXAprrovalParameters lblLable" ID="txtEXAprrovalParameters" runat="server" Text='<%# Eval("Parameters") %>'> ReadOnly="true" >
                                            </asp:TextBox><br />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Decision">
                                        <ItemTemplate>
                                            <%--<asp:DropDownList CssClass="form-control ddlcomment lblLable" SelectedValue='<%# Eval("UWDecision") %>'  ID="ddlredflaguwdecision" runat="server"   >--%>
                                            <asp:DropDownList CssClass="form-control ddlEXAprrovaluwdecision lblLable" ID="ddlEXAprrovaluwdecision" runat="server">
                                                <asp:ListItem Value="">---Select---</asp:ListItem>
                                                <asp:ListItem Value="Acceptance">Acceptance </asp:ListItem>
                                                <asp:ListItem Value="Non Acceptable">Non Acceptable</asp:ListItem>
                                            </asp:DropDownList><br />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="BOEID" HeaderStyle-CssClass="blank" ItemStyle-CssClass="blank">
                                        <ItemTemplate>
                                            <asp:Label ID="lblBoeid" runat="server" Visible="false" Text='<%# Eval("BOEID") %>'> ReadOnly="true"  >
                                            </asp:Label><br />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
    ...
    <div id="divCommentDetails" runat="server" class="col-md-12">
        <!-- added UpdateMode="Conditional"  34.1 Start of Changes; Sushant Devkate - [MFL00905]-->
            ...
            <ContentTemplate>
                <div id="dvPlvcHeader" class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            <div class="form-group">
                                <asp:Button ID="btnPlvcVideo" CssClass="btn-primary" runat="server" Text="Plvc Video" OnClick="btnPlvcVideo_Click" />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div runat="server" id="divSignature" class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RFVSignatr" ControlToValidate="ddlSignature" runat="server" ErrorMessage="Signature matched required"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <%--END HERE--%>
    ...
    <div id="divDecisionDetails" runat="server" class="col-md-12">
        <asp:UpdatePanel ID="updUWdecision" runat="server">
                ...
                <div id="DecisionDtls_container" class="box box-warning box-solid">
                    <div class="box-header with-border">
                        <div class="col-md-12 ">
                            ...
                            <div class="col-md-3">
                                <div class="col-md-3" style="float: right">
                                    <asp:Button ID="btndetach" class="btn-primary btnSave1" runat="server" Text="Detach" OnClientClick="return Confirm();" Visible="false" OnClick="btndetach_Click" />
                                </div>
                                <div class="col-md-18" style="float: right">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12">
                            <asp:Repeater ID="rptDecision" OnItemDataBound="rptDecision_ItemDataBound" OnItemCommand="rptDecision_ItemCommand" runat="server">
                                <HeaderTemplate>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <div class="col-md-12">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Application No</label>
                                                <asp:Label ID="lblAppno" CssClass="form-control" Text='<%#Eval("AppNo") %>' Style="width: 70%;" runat="server" AutoPostBack="True">
                                                    <asp:HiddenField runat="server" ID="hdnPolNum" Value='<%#Eval("PolicyNo") %>' />
                                                </asp:Label>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:Label ID="lblPolNum" CssClass="form-control" Text='<%#Eval("PolicyNo") %>' Style="width: 50%;" runat="server"> 
                                                </asp:Label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Product Name</label>
                                                <asp:Label ID="lblproductname" CssClass="form-control" Text='<%#Eval("ProdcutName") %>' runat="server" AutoPostBack="True">
                                                    <%--<asp:Label ID="lblproductname" CssClass="form-control HideControl" Text='<%#Eval("PolicyNo") %>' Style="width: 100%;" runat="server">--%>
                                                </asp:Label>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="ddlUWDecesion" CssClass="form-control select2 Decision" Style="width: 60%;" runat="server" AutoPostBack="True" onchange="fnLoaderShow();" OnSelectedIndexChanged="ddlUWDecesion_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>

                                        </div>
                                        <div id="divUWDecesioncategory" runat="server" visible="false">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="col-md-6" style="padding: 0px">
                                                        <label>UW Reason1</label>
                                                        <asp:ListBox ID="ddlUWreason1" CssClass="form-control label ddlUWreason1" Style="width: 100%;" runat="server" SelectionMode="Multiple">
                                                            <asp:ListItem Value="sf" Text="sfd" />
                                                        </asp:ListBox>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="col-md-6" style="padding: 0px">
                                                        ...
                                                        <asp:ListBox ID="ddlAcceptanceReason" CssClass="form-control label ddlAcceptanceReason" Style="width: 100%;" runat="server" SelectionMode="Multiple">
                                                            <asp:ListItem Value="sf" Text="sfd" />
                                                        </asp:ListBox>
                                                    </div>
                                                </div>
                                        ...
                                        <%--//44.1 END of Changes; Sagar Thorave - [CR-7049]--%>
                                        <%--//45.1 Begin of Changes; Jayendra - [Webashlar01]--%>
                                       <%-- <div id="divAcceptanceOtherReasonText" runat="server" visible="false" class="divAcceptanceOtherReasonText" style="display:none" >
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="col-md-6" style="padding: 0px">
                                        ...
                                        <div class="divAcceptanceOtherReasonText" style="display:none" id="divAcceptanceOtherReasonText">
                                            <div class="col-md-4">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Acceptance Other Reason Text</label>
                                                        <asp:TextBox ID="txtAcceptanceOtherReasonText" CssClass="form-control txtAcceptanceOtherReasonText" Text="" runat="server"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="divUWReason2" runat="server" visible="false">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>UW Reason2</label>
                                                    <asp:TextBox ID="txtUWreason2" CssClass="form-control" Style="width: 100%;" runat="server" ReadOnly="true">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <%--<div id="divbtnaddnewrow" class="col-md-4 mt-1" style="margin-top: 5px;" runat="server" visible="false">
                                       <div class="col-md-3">
                                        <lable class="form-group"><br></lable>
                                         <div class="col-md-3">
                                         <div class="form-group">
                                             <asp:Button ID="btnaddnewrow_Decision" CssClass="btn btn-primary lnkButton" runat="server" Text="Add New Row" OnClick="btnaddnewrow_Decision_Click" Enabled="true"  />
                                         </div>
                                       </div>
                                       </div>
                                        </div>--%>
                                   </div>
                                    <%--Added By Royson Pinto on 22nd NOV to display Restrict Further Cover--%>
                                    <div runat="server">
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <asp:RadioButton ID="rbYes" runat="server" GroupName="Restrict_Further_Cover" name="restrict_further_cover" Text="Yes" Checked='<%# Eval("Restrict_Further_Cover").ToString()=="True" ? true: false %>' />
                                                <asp:RadioButton ID="rbNo" runat="server" GroupName="Restrict_Further_Cover" name="restrict_further_cover" Text="No" Checked='<%# Eval("Restrict_Further_Cover").ToString()=="False" ? true: false %>' />
                                            </div>
                                        </div>
                                    </div>
                                    <%--End--%>
                        ...
                        <div class="col-md-12">
                            <div id="divbtnaddnewrow" class="col-md-4 mt-1" style="margin-top: 5px;" runat="server">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <asp:Button ID="btnaddnewrow_Decision" CssClass="btn btn-primary lnkButton" runat="server" Text="Add New Row" OnClick="btnaddnewrow_Decision_Click" Enabled="true" />
                                    </div>
                                    ...
                                    <asp:GridView ID="griddecision" CssClass="table table-bordered table-striped" runat="server" AutoGenerateColumns="False">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Application No">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblappno" runat="server" Text='<%# Bind("lblAppno") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Policy No">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpolicyno" runat="server" Text='<%# Bind("lblPolNum") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Remove">
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkDecisionRemoveRow" ClientIDMode="AutoID" runat="server" CssClass="lnkButton" OnClick="lnkDecisionRemoveRow_Click1">
                                                        <asp:Image ID="Image8" Height="45px" runat="server" ImageUrl="~/dist/img/delete2.png" />
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
            ...
            <Triggers>
                ...
                <%--<asp:AsyncPostBackTrigger ControlID="ddlUWreason1" />--%>
            </Triggers>
        </asp:UpdatePanel>
    </div>
        ...
        <ContentTemplate>
            <div class="modal" id="divUserControlModal" role="dialog">
                ...
                <div class="modal-dialog modal-lg">
                    <!-- Modal content-->
                    <div class="modal-content" style="height: 1100px!important">
    ...
    <%--end here--%>
    <!--34.1 End of Changes; Sushant Devkate - [MFL00905]-->
            ...
            <div id="mdISSmokar" class="modal fade modal-info" aria-labelledby="myModalLabel1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="width: 754px; height: 291px">
                        ...
                        <div class="modal-body">
                            <h4>You are changing the Smoker Flag. To proceed, kindly select the reason for modification
                            </h4>
