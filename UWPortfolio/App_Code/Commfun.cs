...
METHODE/EVENT:
REMARK: CHANGES MADE TO DECIDE WHETHER TO CALL REVIVAL OR SARAL PROCESS
DateTime :19MARCH2020
***********************************************************************************************************************************
...
// Description          : 1.API call for ENY score-Method name GetENYDeatils
//*********************************************************************************************************************************/
...
// BRD/CR/Codesk No/Win : display Arya response  in UW comment page
// Date Of Creation     : 26.05.20201           
// Description          : 1.API call for ENY score-Method name GetENYDeatils
//*********************************************************************************************************************************/
...
// Description          : 1.PAN and FORM 60 Flagging validation 
//*********************************************************************************************************************************/
// Sr. No.              : 30
// Company              : Life            
// Module               : UW Saral         
// Program Author       : Sagar Thorave              
// BRD/CR/Codesk No/Win : CR - 30573
// Date Of Creation     : 09.02.2021           
// Description          : 1.Upload and download policy risk flag 
//*********************************************************************************************************************************/
//**********************************************************************
// Sr. No.              : 31
// Company              : Life            
...
// BRD/CR/Codesk No/Win :  CR-3131
// Date Of Creation     : 19/05/2022
...
// Description          : Bind RedFlad grid With database And Update UWDecision
//******************************************************************************************************************************* 
//******************************************************************************************************************************* 
// Sr. No.              : 38
// Company              : Life            
...
public class Commfun
{
    ...
    public void LoadUWsaralPageDetails(ref DataSet _dsAllData, string strPQuoteNo, string AppType, string strUserId)
    {
        try
        {
            ...
            _dsAllData = objSql.RetrieveDataset("usp_UWOnlineAllDetailsApi_Get_V7_Combi", _sqlparam);
	...
	public void OnlineApplicationdashbord_Get(string strUwmode, string struserid, string strUserGroup, string strLnkoption, ref DataSet _dsAppdtls)
	{
		try
		{
			...
			{
				proceName = "usp_UWOnlineDashbordDetails_Get_V7_Testing";
			}
			else
			{
    ...
    public void OnlineApplicationdashbordBucketsCount_Get(string strUwmode, string struserid, string strLinkOption, string strUserGroup, ref DataSet _dsAppdtls)
    {
        try
        {
            ...
            //_dsAppdtls = objSql.RetrieveDataset("usp_UWOnlineDashbordDetails_Get_Offline_Online_V1", _sqlparam); //PROD
    ...
    public void OnlineApplicationLockChecker(string strApplicationNumber, string struserid, string strUserGroup, ref DataSet Result)
    {
        try
        {
            ...
            _sqlparam[1] = new SqlParameter("@UserId", struserid);
            _sqlparam[2] = new SqlParameter("@UserGroup", strUserGroup);
            Result = objSql.RetrieveDataset("USP_UWSral_AppLockChecker_newTest", _sqlparam);
    ...
    public void OnlineTsmrMsarDisplayDetails_GET(ref DataSet _ds, string strPQuoteNo, string strChanneltype)
    {
        try
        {
            ...
            //_ds = objSql.RetrieveDataset("SPR_UWSARAL_MSARTSARFETCHDETAILS_GET_COMBI_V1", _sqlparam);
            _ds = objSql.RetrieveDataset("SPR_UWSARAL_MSARTSARFETCHDETAILS_GET_COMBI_V1", _sqlparam);
        }
        catch (Exception Error)
        {
    ...
    //37.1 Begin of Changes; Bhaumik Patel - [CR-4134]
    ...
    //37.1 End of Changes; Bhaumik Patel - [CR-4134]
    ...
    public void OnlineLoadingDisplayDetails_GET(ref DataSet _ds, string strPQuoteNo, string strReqSource)
    {
        try
        {
            ...
            _ds = objSql.RetrieveDataset("usp_UWOnlineLoadingDetails_Get_CR-3334", _sqlparam);
        }
        catch (Exception Error)
        {
    ...
    public void OnlineMasterDisplayDetails_GET1(ref DataSet _ds)
    {
        try
        {
            ...
            if (_ds.Tables.Count > 0)
            {
                ...
                if (_ds.Tables.Count > 25)
                {
                    _ds.Tables[25].TableName = "ddlRelationStaff";
                }
            }
        }
        catch (Exception Error)
    ...
    //42.1 End of Changes; Bhaumik Patel - [CR - 3334]
    public void OnlineMasterDisplayDetails_GET(ref DataSet _ds)
    {
        try
        {
            Logger.Info("STAG 2 A1 :PageName :Commfun.CS // MethodeName :OnlineMasterDisplayDetails_GET");
            _ds = objSql.RetrieveDataset_woParam("USP_BPM_MasterDetailsFetch_V4");
            if (_ds.Tables.Count > 0)
            {
                _ds.Tables[0].TableName = "ddlfollowupcode";
                _ds.Tables[1].TableName = "ddlCategory";
                ...
                _ds.Tables[8].TableName = "ddlBkdateReason";
                _ds.Tables[9].TableName = "ddlIfscCode";
                //42.1 Begin of Changes; Bhaumik Patel - [CR - 3334]
                // _ds.Tables[10].TableName = "ddlLoadRsn1";
                //_ds.Tables[11].TableName = "ddlLoadRsn2";
                //42.1 End of Changes; Bhaumik Patel - [CR - 3334]

                _ds.Tables[10].TableName = "ddlLoadTypeVal";
                _ds.Tables[11].TableName = "ddlAutoPaytype";
                /*ID:6 STRART*/
                if (_ds.Tables.Count > 12)
                {
                    _ds.Tables[12].TableName = "cblDecisionType";
                }
                if (_ds.Tables.Count > 13)
                {
                    _ds.Tables[13].TableName = "ddlProposalType";
                }
                if (_ds.Tables.Count > 14)
                {
                    _ds.Tables[14].TableName = "ddlProposalType2";
                }
                if (_ds.Tables.Count > 15)
                {
                    _ds.Tables[15].TableName = "ddlProposalType3";
                }
                /*ID:6 END*/
                if (_ds.Tables.Count > 16)
                {
                    _ds.Tables[16].TableName = "ddlRequirementMedicalReason";
                }
                if (_ds.Tables.Count > 17)
                {
                    _ds.Tables[17].TableName = "ddlAnswer";
                }
                //Added by Suraj on 25 APRIL 2018 for Assign type dropdown
                if (_ds.Tables.Count > 18)
                {
                    _ds.Tables[18].TableName = "ddlAssigmentType";
                }
                //Added by Suraj on 5 JULY 2018 for Country list
                if (_ds.Tables.Count > 19)
                {
                    _ds.Tables[19].TableName = "ddlcountry";
                }
                //Added by Suraj on 25 JULY 2019 for signature match
                if (_ds.Tables.Count > 20)
                {
                    _ds.Tables[20].TableName = "ddlSignature";
                }
                //Added by Suraj on 01 JULY 2020 for catagory only for product code E83,84
                if (_ds.Tables.Count > 21)
                {
                    _ds.Tables[21].TableName = "ddlNAWPCatagory";
                }
                if (_ds.Tables.Count > 23)
                {
...
string strbpm_userName, string strbpm_userID, string strbpm_branchCode, string strbpm_userBranch, string strbpm_processName, string strbpm_applicationName, string strlifeAsia_userID, string strChanneltype, string strBackdatingintrest, ref int AppResult)
    ...
    public void OnlineProdcutControlMasterDetails_GET(ref DataSet _ds, string strPQuoteNo, string strAppType)
    {
        ...
        try
        {
            ...
            _ds = objSql.RetrieveDataset("usp_UWSaralProductControlDetails_Get_V1", _sqlparam);//added by suraj for Combi product on 14 JULY 2020
        }
        catch (Exception Error)
        {
            Logger.Error(strPQuoteNo + ":PageName :UWSaralServices/CommFun.CS // MethodeName :OnlineProdcutControlMasterDetails_GET");
...
string strbpm_userID, string strbpm_userName, string strbpmgrp, string strbpm_branchCode, string strbpm_userBranch, string strbpm_processName, string strbpm_applicationName, ref int FundResult)
        ...
        ref int PanResult, string strNDPanStatus, string strNDPanTitle, DateTime? NDLastUpdDate, string strNDPanType)
    {
        try
        {
            ...
            SqlParameter[] _sqlparam = new SqlParameter[20];
    ...
    public void OnlinePremiumExtraLoadingdetails_Save_New(string ApplicationNo, string PolicyNo, string ComponentCd, int RiderPPT, int RiderPT, string RiderCtg, int BackdatedInt
        , long TotalInstalmentPremium, string ReasonOfRateUp, int ModalPremiumAmt, int ExtraPremiumAmt, int SeriveTax, int EduCess, int RevisedPremium, long SumAssured, long SumAssuredAcrossPlans
        , int MedicalLoadingPremium, int MedicalLoadingRate, int NonMedicalLoadingPremium, int BalanceofPremium, int NonMedicalLoadingRate, ref int LoadingPremresult)
    {
        try
        {
           ...
           // _sqlparam[0] = new SqlParameter("@BatchID", BatchID);
            ...
            _sqlparam[1] = new SqlParameter("@PolicyNo", PolicyNo);
            _sqlparam[2] = new SqlParameter("@ComponentCd", ComponentCd);
            _sqlparam[3] = new SqlParameter("@RiderPPT", RiderPPT);
            _sqlparam[4] = new SqlParameter("@RiderPT", RiderPT);
            _sqlparam[5] = new SqlParameter("@RiderCtg", RiderCtg);
            _sqlparam[6] = new SqlParameter("@BackdatedInt", BackdatedInt);
            _sqlparam[7] = new SqlParameter("@TotalInstalmentPremium", TotalInstalmentPremium);
            _sqlparam[8] = new SqlParameter("@ReasonOfRateUp", ReasonOfRateUp);
            _sqlparam[9] = new SqlParameter("@ModalPremiumAmt", ModalPremiumAmt);
            _sqlparam[10] = new SqlParameter("@ExtraPremiumAmt", ExtraPremiumAmt);
            _sqlparam[11] = new SqlParameter("@SeriveTax", SeriveTax);
            _sqlparam[12] = new SqlParameter("@EduCess", EduCess);
            _sqlparam[13] = new SqlParameter("@RevisedPremium", RevisedPremium);
            _sqlparam[14] = new SqlParameter("@SumAssured", SumAssured);
            _sqlparam[15] = new SqlParameter("@SumAssuredAcrossPlans", SumAssuredAcrossPlans);
            _sqlparam[16] = new SqlParameter("@MedicalLoadingPremium", MedicalLoadingPremium);
            _sqlparam[17] = new SqlParameter("@MedicalLoadingRate", MedicalLoadingRate);
            _sqlparam[18] = new SqlParameter("@NonMedicalLoadingPremium", NonMedicalLoadingPremium);
            _sqlparam[19] = new SqlParameter("@BalanceofPremium", BalanceofPremium);
            _sqlparam[20] = new SqlParameter("@NonMedicalLoadingRate", NonMedicalLoadingRate);
            LoadingPremresult = objSql.Insertrecord("USP_UWSaral_ExtraLoadingdetails_Save_New", _sqlparam);
        }
        catch (Exception Error)
        {
            Logger.Error(ApplicationNo + "STAG 2 :PageName :Commfun.CS // MethodeName :OnlinepremiumLoadingDetails_Save Error :" + System.Environment.NewLine + Error.ToString());
...
string bpm_processName, string bpm_applicationName,string LD_reason4, ref int Lodingresult)
    {
        try
        {
            ...
            Lodingresult = objSql.Insertrecord("USP_BPM_LoadingDetailsSave_V2_CR3334", _sqlparam);
        }
        catch (Exception Error)
        {
...
string strbpm_creationDate, string strbpm_systemDate, string strbpm_businessDate, string strbpm_userBranch, string strbpm_processName, string strbpm_applicationName,string UWreason2, string UWReason2value, ref int UWDecisionresult)
    {
        try
        {
            ...
            UWDecisionresult = objSql.Insertrecord("[USP_BPM_UWDecisionDetailsSave_V2_CR3334]", _sqlparam);
        }
        catch (Exception Error)
        {
...
string strBpm_userName, string strBpmgrp, string strBpm_branchCode, string strBpm_userBranch, string strBpm_processName, string strBpm_applicationName, ref int FollowupResult)
    ...
    {
        SqlParameter[] _sqlparam = new SqlParameter[60];
        ...
        //38.1 Begin of changes CR-4971 Sushant Devkate - MFL00905
        _sqlparam[59] = new SqlParameter("@IsNRICustomer", objClientDetails.IsNRICustomer);
        //38.1 End of changes CR-4971 Sushant Devkate - MFL00905
        //BMP CLIENT DETAILS
    ...
    {
        Logger.Info(_dr["LD_APPLICATIONNOSTR"].ToString() + "STAG 3-A :PageName :Commfun.CS // MethodeName :DeleteExistingLoading");
        SqlParameter[] _sqlparam = new SqlParameter[3];
        _sqlparam[0] = new SqlParameter("@PQuoteNo", _dr["LD_APPLICATIONNOSTR"].ToString());
        ...
        response = objSql.Insertrecord("USP_BPM_ExestingLoadingDelete_V2_CR3334", _sqlparam);
    }
    ...
    public void InsertUpdateLeadDocument(string LeadDocumentId, string FileName, string FilePath, string ModifiedBy, bool IsReceived, bool IsVerified, string LeadID, string DocProofId, string DocTypeId, string UWStatus, ref int Result)
    {
        try
        {
            ...
            SqlConnection conn = new SqlConnection(ConfigurationSettings.AppSettings["replica"].ToString());
            SqlCommand command = conn.CreateCommand();
            string strAmlInline = ConfigurationSettings.AppSettings["AmlInline"].ToString();
    ...
    public void GetApplicationDetails(string strApplicationNo, string strUserId, string strChanneltype, ref DataSet _ds)
    {
        ...
        //_ds = objSql.RetrieveDataset("USP_UWSARAL_DASHBOAR_FETCH_APPLICAION_DETAILS_REISSUE", _sqlparam);
    ...
    public void DeleteExistingLoading1(string strAppno, string strRiderId, string strLoadingType, ref int response)
    {
    ...
    /*ID:9 START*/
    public void Save_TsarMsar(DataTable _dt, ref int resp)
    {
        try
        {
            Logger.Info("STAG 2 :PageName :BAL.CS // MethodeName :BindQuestion_CloseFile");
    ...
    /*ID:22 END*/
    public bool CheckIsSignUploaded(string ApplicationNo)
    {
        ...
        try
        {
            ...
            SqlParameter[] _sqlparam = new SqlParameter[1];
            _sqlparam[0] = new SqlParameter("@ApplicationNo", ApplicationNo);
            ds = objSql.RetrieveDataset("usp_GetUploadedSignatureDetails", _sqlparam);
    ...
    //start changes to rupali ezytek rupali
  ...
  string NOMatchData, string CreatedBy, string Type, string ExceptionError, string Comments)
	...
	//End change To rupali ezytek rupali
    ...
    public DataSet FetchRiderDetailsConsentLetter(string ApplicationNo, string Channel)
    {
        try
        {
            ...
            ds = objSql.GetClientDetails("USP_UWSARAL_FETCH_RIDER_V1", _sqlparam);
            return ds;
        }
        catch (Exception)
        {
    ...
    public void GetCombiFlag(ref DataSet _ds, string strAppno)
    {
        ...
        try
        {
            ...
            _sqlparam[0] = new SqlParameter("@AppNo", strAppno);
            // _sqlparam[1] = new SqlParameter("@AppType", strAppType);
            _ds = objSql.RetrieveDataset("GetCombiFlag", _sqlparam);
        }
        catch (Exception Error)
        {
    ...
    public DataSet GetMatchingpolicydetails(string strApplicationNo)
    {
        ...
        try
        {
            ...
            SqlParameter[] _sqlparam = new SqlParameter[1];
            _sqlparam[0] = new SqlParameter("@ApplicationNo", strApplicationNo);
            ds = objSql.GetClientdata("USP_GetMatchingPolicyDetails", _sqlparam);
            return ds;
    ...
    //Added by pragati CR 27524
    public void Save_RsnExcessPremium(string StrMode, string strApplicationNoStr, string RsnExcessPremium, string strBpm_userID, string Country, ref int resp)
    {
        try
        {
            Logger.Info(strApplicationNoStr + "STAG 2 :PageName :Commfun.CS // MethodeName :OnlinefollowupDetails_Save");
            ...
            _sqlparam[0] = new SqlParameter("@Mode", StrMode);
            _sqlparam[1] = new SqlParameter("@Appno", strApplicationNoStr);
            _sqlparam[2] = new SqlParameter("@RsnExcessPremium", RsnExcessPremium);
            _sqlparam[3] = new SqlParameter("@UserId", strBpm_userID);
            _sqlparam[4] = new SqlParameter("@Country", Country);
            resp = objSql.Insertrecord("USP_UWSARAL_SAVE_Country", _sqlparam);
        }
        catch (Exception Error)
        {
    ...
    public void Get_Update_NEW_Client(ref DataSet _dsAllData, string strPQuoteNo, string ClientID)
    {
        try
        {
            Logger.Info("STAG 2 :PageName :Commfun.CS // MethodeName :Get_Update_NEW_Client");
            _dsAppdtls = new DataSet();
            SqlParameter[] _sqlparam = new SqlParameter[2];
            _sqlparam[0] = new SqlParameter("@PQuoteNo", strPQuoteNo);
            _sqlparam[1] = new SqlParameter("@ClientID", ClientID);

            _dsAllData = objSql.RetrieveDataset("USP_UWSARAL_GET_UPDATE_CREATE_CLIENT_FLAG", _sqlparam);

        }
        catch (Exception Error)
        {
            Logger.Error("STAG 2 :PageName :Commfun.CS // MethodeName :Get_Update_NEW_Client Error :" + System.Environment.NewLine + Error.ToString());
            SaveErrorLogs("", "Failed", "UWPortfolio", "Commfun.cs", "Get_Update_NEW_Client", "E-Error", "", "", Error.ToString());
        }
    }
    //CR-28958 End Changes by Shyam Patil

    //27.1 Start ENY Score  Shyam Patil
    public void GetENYDeatils(ref DataSet _dsAllData, string strPQuoteNo, string RequestType)
    {
        try
        {
            Logger.Info("STAG 2 :PageName :Commfun.CS // MethodeName :GetENYDeatils");
            _dsAppdtls = new DataSet();
            SqlParameter[] _sqlparam = new SqlParameter[1];
            _sqlparam[0] = new SqlParameter("@ApplicationNo", strPQuoteNo);

            if (RequestType=="Revival")
            {
                _dsAllData = objSql.RetrieveDataset("usp_ENYScore_ApplicationDetails_Revival", _sqlparam);
            }
            else
            {
                _dsAllData = objSql.RetrieveDataset("usp_ENYScore_ApplicationDetails", _sqlparam);
            }
        ...
        {
            Logger.Error("STAG 2 :PageName :Commfun.CS // MethodeName :GetENYDeatils Error :" + System.Environment.NewLine + Error.ToString());
            SaveErrorLogs("", "Failed", "UWPortfolio", "Commfun.cs", "GetENYDeatils", "E-Error", "", "", Error.ToString());
        }
    }
    //27.1 End ENY Score  Shyam Patil
    //28.1 Start
    public void GetAryaResponse(ref DataSet _ds, string strAppNO)
    {
        try
        {
            Logger.Info(strAppNO + "STAG 3-L :PageName :Commfun.CS // MethodeName :OnlineCommentsDisplayDetails_GET");
            SqlParameter[] _sqlparam = new SqlParameter[1];
            _sqlparam[0] = new SqlParameter("@AppNo", strAppNO);
            _ds = objSql.RetrieveDataset("USP_UWSaral_GetAryaResponse", _sqlparam);
        }
        catch (Exception Error)
        {
            Logger.Error(strAppNO + "STAG 2 :PageName :Commfun.CS // MethodeName :OnlineCommentsDisplayDetails_GET Error :" + System.Environment.NewLine + Error.ToString());
    ...
    //29.1 Begin of Changes; Pooja Shetye - [1133038]
    ...
    //29.1 End of Changes; Pooja Shetye - [1133038]
    ...
    //30-1 Start of changes: Sagar Thorave[MFL00886] CR- 30573
    ...
    //30-1 End of changes: Sagar Thorave[MFL00886] CR- 30573
    ...
    #endregion End 32.1: This CR-2639 changes done by Sushant Devkate MFL00905 
    ...
    public DataSet getFGDataShow_Impact(string ApplicationNo, string CreatedBy)
    {
        try
        {
            ...
            _sqlparam[0] = new SqlParameter("@Input_Proposal_Policy_No", ApplicationNo);
            _sqlparam[1] = new SqlParameter("@CreatedBy", CreatedBy);
            ds = objSql.RetrieveDataset("usp_UWSaralGetFGData_Impact", _sqlparam);
            return ds;
        }
        catch (Exception)
        {
...
string NOMatchData, string Userid, int ResponseCode)
    ...
    //32.1 Begin of Changes; Sagar Thorave - [MFL00886]
    ...
    public DataSet GetMerVideoDetails(string applNo)
    {
        try
        {
            _dsAppdtls = new DataSet();
            SqlParameter[] _sqlparam = new SqlParameter[1];
            _sqlparam[0] = new SqlParameter("@ApplicationNo", applNo);

            _dsAppdtls = objSql.RetrieveDataset("sp_Featch_LF_MerDetails", _sqlparam);
        }
        catch (Exception Error)
        {
            string msg = Error.Message;
    ...
    //32.1 End of Changes; Sagar Thorave - [MFL00886]
    ...
    #region 36.1 Begin Of Changes Of CR-2394 Validation coustomer mob with agent by Sushant Devkate [MFL00905]
            ...
            if (ds.Tables.Count > 0)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        ObjCoustomerDODO.ClientMode = Utility.Getstring(ds.Tables[0].Rows[i]["ClientMode"]);
                        ObjCoustomerDODO.IsNRICustomer = Convert.ToBoolean(ds.Tables[0].Rows[i]["IsNRICustomer"]);
                        OBjlistCoustomerDO.Add(ObjCoustomerDODO);
                    }
                }
    ...
    #endregion 37.1 End Of Changes Of CR-2394 Validation coustomer mob with agent by Sushant Devkate [MFL00905]

    #region 38.1 Begin Of Changes Of CR-30543 changes by Sushant Devkate [MFL00905]
    ...
    #endregion 38.1 End Of Changes Of CR-30543 changes by Sushant Devkate [MFL00905]

    #region  37.1 Bigin Of Changes Of CR-4134 RedFlag [Webshlar02]
    ...
    #endregion 37.1 End Of Changes Of CR-4134 RedFlag [Webshlar02]


    #region Begin of changes CR-4971 Sushant Devkate -MFL00905
    public bool GetcheckISNRICustomer(string ApplicationNo)
    {
        bool IsScuccess = false;
        try
        {
            ...
            IsScuccess = objSql.IsCheckData("Usp_GetcheckISNRICustomer", _sqlparam);
        }
        catch (Exception ex)
        {
            IsScuccess = false;
    ...
    #endregion End of changes CR-4971 Sushant Devkate -MFL00905
    ...
    public bool IsUinNoStatusCheck(string ApplicationNo)
    {
        ...
        try
        {
            SqlParameter[] _sqlparam = new SqlParameter[1];
            _sqlparam[0] = new SqlParameter("@ApplicationNo", ApplicationNo);
            IsUinNoStatus = objSql.IsCheckData("Usp_CheckUINNoStatus", _sqlparam);
        }
        catch (Exception ex)
        {
            IsUinNoStatus = false;
    ...
    public void OnlinelReason_Based_loadType_MasterDetails_GET(ref DataSet _ds, string strPQuoteNo, string loadtype, string strAppType)
    {
        ...
        try
        {
            ...
            _ds = objSql.RetrieveDataset("USP_BPM_MasterDtlFatch_Reason_BasedOnLoadingType", _sqlparam);
        }
        catch (Exception Error)
        {
    ...
    public void OnlineDecisionDetails_Save( string DD_applicationNoStr,
string DD_DecisionType, string DD_category, string DD_reason1, string DD_reason2, string DD_Period, string bpm_userID, string bpm_userName, string bpmgrp, string bpm_userBranch,
string bpm_processName,  ref int Decisionresult)
    {
        try
        {
    ...
    //43.1 Added By Royson Pinto on 22nd NOV to store Restrict Further Cover
    ...
    public dynamic GetDeclineThirdParty(string application)
    {
        SqlParameter[] _sqlparam = new SqlParameter[1];
        _sqlparam[0] = new SqlParameter("@Application_Number", application);
        return objSql.RetrieveDataset("usp_GetDeclineThirdParty", _sqlparam);
    }
    public void UpdateUCNNumber(string Application_Number,string comment,string username)
    {
        try
        {
            SqlParameter[] _sqlparam = new SqlParameter[5];
            ...
            _sqlparam[3] = new SqlParameter("@Comments", comment);
            _sqlparam[4] = new SqlParameter("@User_name", username);
    ...
    //43.1 End By Royson Pinto on 22nd NOV to store Restrict Further Cover

    //Added By Royson Pinto on 16th Feb Decline Third Party for CR 4783 CR-7
    ...
    //44.1 Begin of Changes; Bhaumik Patel - [CR-4753]
    public void OnlineEXAprrovalDetails_GET(ref DataSet _ds, string strPQuoteNo, string Mode)
    {
        Logger.Info(strPQuoteNo + ":PageName :UWSaralServices/CommFun.CS // MethodeName :OnlineEXAprrovalDetails_GET");
        try
        {
            SqlParameter[] _sqlparam = new SqlParameter[2];
            _sqlparam[0] = new SqlParameter("@Mode", Mode);
            ...
            _ds = objSql.RetrieveDataset("Sp_Get_BOEChecklistDetails", _sqlparam);


        }
        catch (Exception Error)
        {
            Logger.Error(strPQuoteNo + ":PageName :UWSaralServices/CommFun.CS // MethodeName :OnlineEXAprrovalDetails_GET");
            SaveErrorLogs(strPQuoteNo, "Failed", "UWSaralDecision", "Commfun.cs", "OnlineEXAprrovalDetails_GET", "E-Error", "", "", Error.ToString());
        }
    }

    public void Online_Insert_EXAprrovalDetails(string strAppNo,string Boeid, string PolicyNo, string Parameters, string Decision, string Aprrove_By, string ProcessName, string Userid,ref int result)
    {
        Logger.Info(strAppNo + ":PageName :UWSaralServices/CommFun.CS // MethodeName :Online_Insert_EXAprrovalDetails");
        try
        {
            SqlParameter[] _sqlparam = new SqlParameter[8];
            _sqlparam[0] = new SqlParameter("@ApplicationNo", strAppNo);
            _sqlparam[1] = new SqlParameter("@BOEID", Boeid);
            _sqlparam[2] = new SqlParameter("@PolicyNo", PolicyNo);
            _sqlparam[3] = new SqlParameter("@Parameters", Parameters);
            _sqlparam[4] = new SqlParameter("@Decision", Decision);
            _sqlparam[5] = new SqlParameter("@Aprrove_By", Aprrove_By);
            _sqlparam[6] = new SqlParameter("@ProcessName", ProcessName);
            _sqlparam[7] = new SqlParameter("@Created_By", Userid);
             result = objSql.Insertrecord("Sp_Insert_ExceptionAprrovalDeatils", _sqlparam);

        }
        catch (Exception Error)
        {
            Logger.Error(strAppNo + ":PageName :UWSaralServices/CommFun.CS // MethodeName :Online_Update_Online_Insert_EXAprrovalDetailsRedFlagDetails");
            SaveErrorLogs(strAppNo, "Failed", "UWSaralDecision", "Commfun.cs", "Online_Insert_EXAprrovalDetails", "E-Error", "", "", Error.ToString());
        }


    }

    //44.1 End of Changes; Bhaumik Patel - [CR-4753]
